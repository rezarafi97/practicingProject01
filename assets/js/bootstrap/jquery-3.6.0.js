...
var isFunction = function isFunction( obj ) {
		...
		// (e.g., `typeof document.getElementsByTagName("section") === "function"`). (gh-4756)
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	support.scope = assert( function( el ) {
		docElem.appendChild( el ).appendChild( document.createElement( "section" ) );
		return typeof el.querySelectorAll !== "undefined" &&
			!el.querySelectorAll( ":scope fieldset section" ).length;
	} );
...
( function() {
	...
	// the select element.
	section.innerHTML = "<option></option>";
	support.option = !!section.lastChild;
} )();
	...
	jQuery.extend( support, {
		...
		reliableTrDimensions: function() {
			...
			if ( reliableTrDimensionsVal == null ) {
				...
				trChild = document.createElement( "section" );
				...
				// display for all section elements is set to "inline",
				// which causes a problem only in Android 8 Chrome 86.
				// Ensuring the section is display: block
